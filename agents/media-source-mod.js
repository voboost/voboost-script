...
function init() {
    ...
    MediaTabHolder = Java.use("com.pateo.voyah.mediaCard.home.view.mediaTab97c.MediaTabAdapter97c$MediaTabHolder");
...
function main() {
    ...
    Java.scheduleOnMainThread(() => { reconnectMedia(); });
    Java.scheduleOnMainThread(() => { changeTabIcon(); });
