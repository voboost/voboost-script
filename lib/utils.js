...
export const LANGUAGE_CONFIG_PATH = '/data/local/tmp/voboost/language-config.json';
export const PHONE_NUM_CONFIG_PATH = '/data/local/tmp/voboost/phone-num-config.json';
export const APP_CONFIG_PATH = '/data/local/tmp/voboost/apps-config.json';
export const WEATHER_CONFIG_PATH = '/data/local/tmp/voboost/weather-config.json';
export const APP_VIEWPORT_CONFIG_PATH = '/data/local/tmp/voboost/apps-viewport-config.json';
export const KEYBOARD_TEMPLATE_PATH = '/data/local/tmp/voboost/skb-qwerty-ru-no-voice.json';
export const KEYBOARD_RU_CONFIG_PATH = '/data/local/tmp/voboost/keyboard-ru-config.json';
export const KEYBOARD_LOCK_EN_CONFIG_PATH = '/data/local/tmp/voboost/keyboard-lock-en-config.json';
export const MEDIA_SOURCE_CONFIG_PATH = '/data/local/tmp/voboost/media-source-config.json';
